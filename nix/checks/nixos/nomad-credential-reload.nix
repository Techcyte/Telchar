# Verifies protected Nomad token rotation and narrow Telchar configuration reload.
{
  pkgs,
  system,
  telchar,
...
pkgs.testers.nixosTest {
  name = "telchar-nixos-nomad-credential-reload";
  ...
  testScript = ''
    ...
    gateway.succeed("mv /var/lib/telchar/credentials/nomad-token.candidate /var/lib/telchar/credentials/nomad-token; systemctl kill --kill-whom=main --signal=HUP telchar.service")
