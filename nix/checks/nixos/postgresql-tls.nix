...
pkgs.testers.nixosTest {
  ...
  testScript = ''
    ...
    gateway.succeed("printf '%s\n' 'postgresql://telchar@postgres.database.test/telchar?sslmode=disable&options=sslmode=verify-full&application_name=sslrootcert=/var/lib/telchar/credentials/postgresql-ca.crt' > /var/lib/telchar/credentials/database-url")
