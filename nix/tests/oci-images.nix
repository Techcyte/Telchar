...
assert telcharImage.imageTag == "2026.8.0";
assert
...
assert nixDaemonImage.imageTag == "2026.8.0";
assert
...
assert sshIngressImage.imageTag == "2026.8.0";
assert
...
assert nomadWorkerImage.imageTag == "2026.8.0";
assert
