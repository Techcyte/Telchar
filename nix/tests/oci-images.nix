...
assert telcharImage.imageTag == "2026.8.1";
assert
...
assert nixDaemonImage.imageTag == "2026.8.1";
assert
...
assert sshIngressImage.imageTag == "2026.8.1";
assert
...
assert nomadWorkerImage.imageTag == "2026.8.1";
assert
