...
use crate::store::promotion::RegisteredPathInfo;
...
pub fn export_verified_nar(
    ...
    let limits = crate::service::transfer_limits::TransferLimits::from_environment()?;
    let mut session =
        crate::service::transfer_limits::TransferBudget::new(limits.maximum_outbound_session_bytes);
    let rates = crate::service::transfer_limits::RateAdmissionState::new(&limits);
...
pub fn export_verified_nar_with_limits(
    ...
    sink: &mut impl Write,
    backend: &mut (impl StoreExportBackend + ?Sized),
    limits: &crate::service::transfer_limits::TransferLimits,
    session: &mut crate::service::transfer_limits::TransferBudget,
) -> io::Result<VerifiedStoreExport> {
    let rates = crate::service::transfer_limits::RateAdmissionState::new(limits);
