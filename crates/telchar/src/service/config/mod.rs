...
const MAXIMUM_NOMAD_RESOURCE_PROFILES: usize = 64;
const MAXIMUM_NOMAD_CONSTRAINT_FIELD_BYTES: usize = 1_024;
const DEFAULT_NOMAD_PRIORITY: u8 = 50;
const MINIMUM_NOMAD_PRIORITY: u8 = 1;
const MAXIMUM_NOMAD_PRIORITY: u8 = 100;
...
const MAXIMUM_NOMAD_RETRIES: usize = 100;
const DEFAULT_NOMAD_MAXIMUM_MANIFEST_PATHS: usize = 65_536;
const DEFAULT_NOMAD_MAXIMUM_MANIFEST_BYTES: u64 = 8 * 1024 * 1024;
const DEFAULT_NOMAD_MAXIMUM_INPUT_NAR_BYTES: u64 = 16 * 1024 * 1024 * 1024;
const DEFAULT_NOMAD_MAXIMUM_TOTAL_INPUT_BYTES: u64 = 64 * 1024 * 1024 * 1024;
const DEFAULT_NOMAD_MAXIMUM_OUTPUT_NAR_BYTES: u64 = 16 * 1024 * 1024 * 1024;
const DEFAULT_NOMAD_MAXIMUM_TOTAL_OUTPUT_BYTES: u64 = 64 * 1024 * 1024 * 1024;
const DEFAULT_NOMAD_MAXIMUM_FRAME_METADATA_BYTES: usize = 1024 * 1024;
const DEFAULT_NOMAD_STREAM_BUFFER_BYTES: usize = 256 * 1024;
const DEFAULT_NOMAD_MAXIMUM_LIVE_LOG_CHUNK_BYTES: usize = 64 * 1024;
const DEFAULT_NOMAD_LIVE_LOG_QUEUE_BYTES: usize = 1024 * 1024;
const DEFAULT_NOMAD_TRANSFER_IDLE_TIMEOUT_SECONDS: u64 = 30;
const DEFAULT_NOMAD_SETUP_TIMEOUT_SECONDS: u64 = 300;
const DEFAULT_NOMAD_OUTPUT_COLLECTION_TIMEOUT_SECONDS: u64 = 1_800;
const DEFAULT_NOMAD_MAXIMUM_CONNECTION_LIFETIME_SECONDS: u64 = 3_600;
const DEFAULT_NOMAD_AUTHENTICATION_LIFETIME_SECONDS: u64 = 300;
const DEFAULT_NOMAD_CLOCK_SKEW_SECONDS: u64 = 30;
const DEFAULT_NOMAD_NONCE_RETENTION_SECONDS: u64 = 600;
const DEFAULT_NOMAD_RECONNECT_TIMEOUT_SECONDS: u64 = 30;
const DEFAULT_NOMAD_MAXIMUM_DIAGNOSTIC_BYTES: usize = 64 * 1024;
